...
$aUtilVerStable = "v2.6.3" ; (2021-12-09)
$aUtilVerBeta = "v2.6.3" ; (2021-12-09)
$aUtilVersion = $aUtilVerStable
Global $aUtilVerNumber = 12
; 1 = v2.3.3
; 2 = v2.3.4
; 3 = v2.5.0
; 4 = v2.5.1/2/3
...
;~ 			$aServerPlayers = "0"
		...
		Else
			...
			For $i = 0 To ($tUserCnt - 1)
				$tUserAll[$i] = _ArrayToString(_StringBetween($tUser1[$i], ", ", ", ")) ;kim125er!
