...
$aUtilVerStable = "v2.3.2" ; (2020-06-29)
$aUtilVerBeta = "v2.3.2" ; (2020-06-29)
...
;~ 				_ArrayDisplay($tQueryCheckResult) ; kim125er
;~ 				MsgBox(0, "Kim", _ArrayToString($tQueryCheckResult) ;kim125er
