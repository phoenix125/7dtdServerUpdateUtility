...
#AutoIt3Wrapper_Outfile=Builds\7dtdServerUpdateUtility_v2.1.4.exe
#AutoIt3Wrapper_Outfile_x64=Builds\7dtdServerUpdateUtility_x64_v2.1.4.exe
...
#AutoIt3Wrapper_Res_ProductVersion=2.1.4
...
$aUtilVersion = "v2.1.4" ; (2019-02-13)
...
Func GetLatestVersion($sCmdDir)
	...
	Else
		...
		If $aServerVer = 0 Then
			FileWriteLine($aLogFile, _NowCalc() & " [Update Check] Using SteamCMD Stable Branch. Latest version: " & $hBuildID)
		Else
			FileWriteLine($aLogFile, _NowCalc() & " [Update Check] Using SteamCMD Experimental Branch. Latest version: " & $hBuildID)
		EndIf
	EndIf
	FileClose($hFileOpen)
	If FileExists($sFilePath) Then
