...
#AutoIt3Wrapper_Outfile=Builds\7dtdServerUpdateUtility_v2.3.0(beta1).exe
...
$aUtilVerBeta = "v2.3.0(beta1)" ; (2019-03-22)
...
Func ShowOnlineGUI()
	;	MsgBox(0,"Kim-Before","ServerOnlinePlayerYN:" & $aServerOnlinePlayerYN & @CRLF & "$aPlayerCountWindowTF:" & $aPlayerCountWindowTF & @CRLF & "$tOnlinePlayerReady:" & $tOnlinePlayerReady)
	If $aServerOnlinePlayerYN = "yes" Then
	...
	;	MsgBox(0,"Kim-After","ServerOnlinePlayerYN:" & $aServerOnlinePlayerYN & @CRLF & "$aPlayerCountWindowTF:" & $aPlayerCountWindowTF & @CRLF & "$tOnlinePlayerReady:" & $tOnlinePlayerReady)
