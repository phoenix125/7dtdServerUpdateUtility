...
#AutoIt3Wrapper_Outfile=Builds\7dtdServerUpdateUtility_v2.0.1.exe
#AutoIt3Wrapper_Outfile_x64=Builds\7dtdServerUpdateUtility_x64_v2.0.1.exe
...
$aUtilVersion = "v2.0.1" ; (2019-02-05)
...
Func ReadUini($sIniFile, $sLogFile)
	...
	Global $sUseDiscordBotScheduled = IniRead($sIniFile, " --------------- DISCORD INTEGRATION --------------- ", "Send Discord message for scheduled restarts? (yes/no)", $iniCheck)
	...
	Global $sUseTwitchBotScheduled = IniRead($sIniFile, " --------------- TWITCH INTEGRATION --------------- ", "Send Twitch message for scheduled restarts? (yes/no)", $iniCheck)
...
Func UpdateIni($sIniFile)
	...
	FileWriteLine($sIniFile, @CRLF)
	IniWrite($sIniFile, " --------------- DISCORD INTEGRATION --------------- ", "Send Discord message for scheduled restarts? (yes/no)", $sUseDiscordBotScheduled)
	...
	FileWriteLine($sIniFile, @CRLF)
	IniWrite($sIniFile, " --------------- TWITCH INTEGRATION --------------- ", "Send Twitch message for scheduled restarts? (yes/no)", $sUseTwitchBotScheduled)
