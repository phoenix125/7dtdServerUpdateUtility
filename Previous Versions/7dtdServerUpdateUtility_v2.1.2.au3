...
#AutoIt3Wrapper_Outfile=Builds\7dtdServerUpdateUtility_v2.1.2.exe
#AutoIt3Wrapper_Outfile_x64=Builds\7dtdServerUpdateUtility_x64_v2.1.2.exe
...
$aUtilVersion = "v2.1.2" ; (2019-02-11)
...
Func FPRun()
	...
	Local $tConfigReadb = StringRegExpReplace($tConfigReada, "(*CRLF)(?m)^.*?\Q" & "TelnetEnabled" & "\E.*?\r\n", "")
