...
#AutoIt3Wrapper_Outfile=Builds\7dtdServerUpdateUtility_v2.3.5.exe
...
If $aCFGLastVerNumber < 3 Then
	...
	IniWrite($aIniFile, " --------------- DISCORD WEBHOOK --------------- ", "Discord #1 Bot Avatar URL (optional) ###", $sDiscordBotAvatar)
	...
	IniWrite($aIniFile, " --------------- DISCORD MESSAGES --------------- ", "Player Died Message (\p - Player Name, \n Next Line) (Blank to disable) ###", '""*\p died.*""')
	IniWrite($aIniFile, " --------------- DISCORD MESSAGES --------------- ", "Player Chat (\p - Player Name, \m Message) (Blank to disable) ###", '""[Chat] **\p**: \m""')
...
;~ 					EndIf
				...
				If $aRebootReason = "update" Then
					...
					EndIf
					If $sUseDiscordBotUpdate = "yes" Then _SendDiscordStatus($aRemoteMsgDiscord[$aAnnounceCount0])
...
Func _SendDiscordChat($tMsg)
	_SendDiscordMsg($tMsg, $aServerDiscordWHSelChat)
...
Func ReadUini($aIniFile, $sLogFile)
	...
	Global $aServerDiscord1Avatar = IniRead($aIniFile, " --------------- DISCORD WEBHOOK --------------- ", "Discord #1 Bot Avatar URL (optional) ###", $iniCheck)
	...
	Global $sDiscordPlayerDiedMsg = IniRead($aIniFile, " --------------- DISCORD MESSAGES --------------- ", "Player Died Message (\p - Player Name, \n Next Line) (Blank to disable) ###", $iniCheck)
	Global $sDiscordPlayerChatMsg = IniRead($aIniFile, " --------------- DISCORD MESSAGES --------------- ", "Player Chat (\p - Player Name, \m Message) (Blank to disable) ###", $iniCheck)
...
Func UpdateIni($aIniFile)
	...
	IniWrite($aIniFile, " --------------- GAME SERVER CONFIGURATION --------------- ", "SteamCMD extra commandline parameters (See note below) ###", $aSteamExtraCMD)
	FileWriteLine($aIniFile, ' NOTE: hardcoded steamcmd commandline includes: steamcmd.exe +@ShutdownOnFailedCommand 1 +@NoPromptForPassword 1 +login anonymous +force_install_dir "%gamepath%" +app_update ' & $aSteamAppID)
	FileWriteLine($aIniFile, @CRLF)
	...
	IniWrite($aIniFile, " --------------- DISCORD WEBHOOK --------------- ", "Discord #1 Bot Avatar URL (optional) ###", $aServerDiscord1Avatar)
	...
	IniWrite($aIniFile, " --------------- DISCORD MESSAGES --------------- ", "Player Died Message (\p - Player Name, \n Next Line) (Blank to disable) ###", $sDiscordPlayerDiedMsg)
	IniWrite($aIniFile, " --------------- DISCORD MESSAGES --------------- ", "Player Chat (\p - Player Name, \m Message) (Blank to disable) ###", $sDiscordPlayerChatMsg)
	FileWriteLine($aIniFile, @CRLF)
...
;~ 			If $aPlayerCountWindowTF = False Then
				...
				EndIf
				$wPlayer = GUICreate(@ScriptName, $aGUIW, $aGUIH, -1, -1, BitOR($GUI_SS_DEFAULT_GUI, $WS_SIZEBOX, $WS_THICKFRAME)) ;Creates the GUI window
...
;~ 				$aPlayerCountWindowTF = True
			...
			EndIf
			$iEdit = GUICtrlCreateEdit($tTxt, 0, 0, $aGUIW, $aGUIH, BitOR($ES_AUTOVSCROLL, $ES_NOHIDESEL, $ES_WANTRETURN, $WS_VSCROLL, $WS_HSCROLL, $ES_READONLY), $WS_EX_STATICEDGE)
			ControlClick($wPlayer, "", $iEdit)
...
Func _SendDiscordJoin($tMsg)
	_GetPlayerCount()
;~ 	MsgBox(0, "Join", $tMsg) ;kim125er
EndFunc   ;==>_SendDiscordJoin
Func _SendDiscordLeave($tMsg)
	_GetPlayerCount()
;~ 	MsgBox(0, "Leave", $tMsg) ;kim125er
...
Func GUI_Config()
	...
	Else
		...
		Global $W1_T1_I_DIR = GUICtrlCreateInput("W1_T1_I_DIR", 123, 59, 300, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T1_I_ConfigFile = GUICtrlCreateInput("W1_T1_I_ConfigFile", 124, 87, 220, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetOnEvent(-1, "W1_T1_I_ConfigFileChange")
		Global $W1_T1_B_Config = GUICtrlCreateButton("Select File", 347, 87, 76, 25)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetOnEvent(-1, "W1_T1_B_ConfigClick")
		Global $W1_T1_B_ImportSettings = GUICtrlCreateButton("Import Settings", 427, 86, 95, 25)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetOnEvent(-1, "W1_T1_B_ImportSettingsClick")
		Global $W1_T1_I_IP = GUICtrlCreateInput("192.168.1.1", 124, 120, 86, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetOnEvent(-1, "W1_T1_I_IPChange")
		Global $Label4 = GUICtrlCreateLabel("Config File", 52, 90, 67, 20)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetOnEvent(-1, "Label4Click")
		Global $Label3 = GUICtrlCreateLabel("Local IP", 63, 125, 52, 20)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetOnEvent(-1, "Label3Click")
		Global $Label36 = GUICtrlCreateLabel("(ie. 192.168.1.10)", 217, 121, 101, 20)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T1_I_SteamBranch = GUICtrlCreateInput("W1_T1_I_SteamBranch", 353, 195, 118, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetOnEvent(-1, "W1_T1_I_SteamBranchChange")
		Global $W1_T1_I_SteamUsername = GUICtrlCreateInput("(optional)", 195, 223, 86, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetOnEvent(-1, "W1_T1_I_SteamUsernameChange")
		Global $W1_T1_I_SteamPassword = GUICtrlCreateInput("(optional)", 385, 223, 86, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetOnEvent(-1, "W1_T1_I_SteamPasswordChange")
		Global $W1_T1_R_NOValidate = GUICtrlCreateRadio("NO Validate", 501, 202, 96, 17)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetOnEvent(-1, "W1_T1_R_NOValidateClick")
		Global $W1_T1_R_Validate = GUICtrlCreateRadio("Validate", 501, 224, 67, 17)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T1_C_Daily = GUICtrlCreateCheckbox("Daily", 61, 365, 51, 17)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetOnEvent(-1, "W1_T1_C_DailyClick")
		Global $W1_T1_C_Sun = GUICtrlCreateCheckbox("Sun", 135, 365, 45, 17)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetOnEvent(-1, "W1_T1_C_SunClick")
		Global $W1_T1_C_Mon = GUICtrlCreateCheckbox("Mon", 190, 365, 53, 17)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetOnEvent(-1, "W1_T1_C_MonClick")
		Global $W1_T1_C_Tues = GUICtrlCreateCheckbox("Tues", 251, 365, 55, 17)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetOnEvent(-1, "W1_T1_C_TuesClick")
		Global $W1_T1_C_Wed = GUICtrlCreateCheckbox("Wed", 311, 365, 53, 17)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetOnEvent(-1, "W1_T1_C_WedClick")
		Global $W1_T1_C_Thurs = GUICtrlCreateCheckbox("Thur", 373, 365, 51, 17)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetOnEvent(-1, "W1_T1_C_ThursClick")
		Global $W1_T1_C_Fri = GUICtrlCreateCheckbox("Fri", 435, 365, 43, 17)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetOnEvent(-1, "W1_T1_C_FriClick")
		Global $W1_T1_C_Sat = GUICtrlCreateCheckbox("Sat", 486, 365, 51, 17)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T1_I_BackupOutFolder = GUICtrlCreateInput("W1_T1_I_DIR", 188, 453, 267, 21)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T1_I_BackupCm = GUICtrlCreateInput("W1_T1_I_DIR", 387, 482, 183, 21)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetOnEvent(-1, "W1_T1_I_BackupCmChange")
		Global $W1_T1_I_BackupNumberToKeep = GUICtrlCreateInput("1", 792, 360, 47, 24)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T1_I_BackupFullEvery = GUICtrlCreateInput("0", 758, 430, 48, 21)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T1_I_BackupMaxWaitSec = GUICtrlCreateInput("30", 792, 476, 47, 21)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T1_I_BackupCmd = GUICtrlCreateInput("W1_T1_I_DIR", 566, 508, 316, 24)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		GUICtrlCreateGroup("", -99, -99, 1, 1)
		Global $Pic1 = GUICtrlCreatePic("K:\AutoIT\_MyProgs\7dtdServerUpdateUtility\Pics\zombiehorde.jpg", 614, 170, 274, 165)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T2_E_PauseForMapGeneration = GUICtrlCreateInput("1", 107, 86, 53, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T2_I_PauseForStarted = GUICtrlCreateInput("1", 107, 115, 53, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T2_I_FailedResponses = GUICtrlCreateInput("1", 107, 144, 53, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T2_I_QueryCheckEvery = GUICtrlCreateInput("30", 651, 207, 49, 24)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T2_I_TelnetCheckEvery = GUICtrlCreateInput("30", 651, 240, 49, 24)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		GUICtrlCreateGroup("", -99, -99, 1, 1)
		Global $Pic2 = GUICtrlCreatePic("K:\AutoIT\_MyProgs\7dtdServerUpdateUtility\Pics\zombiedog.jpg", 610, 336, 222, 180)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T3_C_Daily = GUICtrlCreateCheckbox("Daily", 142, 90, 51, 17)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH)
		GUICtrlSetOnEvent(-1, "W1_T3_C_DailyClick")
		Global $W1_T3_C_Sun = GUICtrlCreateCheckbox("Sun", 216, 90, 45, 17)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH)
		GUICtrlSetOnEvent(-1, "W1_T3_C_SunClick")
		Global $W1_T3_C_Mon = GUICtrlCreateCheckbox("Mon", 271, 90, 53, 17)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH)
		GUICtrlSetOnEvent(-1, "W1_T3_C_MonClick")
		Global $W1_T3_C_Tues = GUICtrlCreateCheckbox("Tues", 332, 90, 55, 17)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH)
		GUICtrlSetOnEvent(-1, "W1_T3_C_TuesClick")
		Global $W1_T3_C_Wed = GUICtrlCreateCheckbox("Wed", 392, 90, 53, 17)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH)
		GUICtrlSetOnEvent(-1, "W1_T3_C_WedClick")
		Global $W1_T3_C_Thur = GUICtrlCreateCheckbox("Thur", 454, 90, 51, 17)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH)
		GUICtrlSetOnEvent(-1, "W1_T3_C_ThurClick")
		Global $W1_T3_C_Fri = GUICtrlCreateCheckbox("Fri", 516, 90, 43, 17)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH)
		GUICtrlSetOnEvent(-1, "W1_T3_C_FriClick")
		Global $W1_T3_C_Sat = GUICtrlCreateCheckbox("Sat", 567, 90, 51, 17)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH)
		...
		Global $W_T3_I_RestartMinute = GUICtrlCreateInput("0", 141, 182, 47, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetOnEvent(-1, "W_T3_I_RestartMinuteChange")
		Global $W1_T3_U_RestartMinute = GUICtrlCreateUpdown($W_T3_I_RestartMinute)
		GUICtrlSetLimit(-1, 59, 0)
		...
		Global $W1_T3_I_RemoteRestartPort = GUICtrlCreateInput("W1_T3_I_RemoteRestartPort", 256, 260, 65, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetOnEvent(-1, "W1_T3_I_RemoteRestartPortChange")
		Global $W1_T3_I_RemoteRestartKey = GUICtrlCreateInput("Input1", 367, 260, 65, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetOnEvent(-1, "W1_T3_I_RemoteRestartKeyChange")
		Global $W1_T3_I_RemoteRestartCode = GUICtrlCreateInput("Input1", 491, 260, 65, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		GUICtrlCreateGroup("", -99, -99, 1, 1)
		Global $Pic3 = GUICtrlCreatePic("K:\AutoIT\_MyProgs\7dtdServerUpdateUtility\Pics\zombie1.jpg", 702, 164, 173, 251)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T4_I_DailyMins = GUICtrlCreateInput("W1_T4_I_DailyMins", 356, 173, 75, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T4_I_UpdateMins = GUICtrlCreateInput("Input1", 356, 202, 75, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T4_I_UpdateRemote = GUICtrlCreateInput("Input1", 356, 231, 75, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T4_I_AnnounceDaily = GUICtrlCreateInput("W1_T4_I_AnnounceDaily", 195, 350, 677, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T4_I_AnnounceUpdate = GUICtrlCreateInput("W1_T4_I_AnnounceDaily", 195, 378, 677, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T4_I_AnnounceRemote = GUICtrlCreateInput("W1_T4_I_AnnounceDaily", 195, 406, 677, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T4_I_BackupStarted = GUICtrlCreateInput("W1_T4_I_AnnounceBackup", 195, 449, 677, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetOnEvent(-1, "W1_T4_I_BackupStartedChange")
		GUICtrlCreateGroup("", -99, -99, 1, 1)
		Global $Group18 = GUICtrlCreateGroup("Online Players Check", 20, 52, 377, 77)
		GUICtrlSetFont(-1, 10, 400, 0, "arial")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T4_I_LogOnlinePlaySeconds = GUICtrlCreateInput("W1_T4_I_LogOnlinePlaySeconds", 289, 73, 33, 24)
		GUICtrlSetOnEvent(-1, "W1_T4_I_LogOnlinePlaySecondsChange")
		Global $Label91 = GUICtrlCreateLabel("seconds", 328, 77, 56, 20)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		...
		GUICtrlCreateGroup("", -99, -99, 1, 1)
		Global $Pic6 = GUICtrlCreatePic("K:\AutoIT\_MyProgs\7dtdServerUpdateUtility\Pics\zombie6.jpg", 596, 38, 169, 109)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T5_I_D1URL = GUICtrlCreateInput("W1_T5_I_D1URL", 181, 64, 677, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetOnEvent(-1, "W1_T5_I_D1URLChange")
		Global $W1_T5_I_D1Bot = GUICtrlCreateInput("Input1", 181, 93, 101, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetOnEvent(-1, "W1_T5_I_D1BotChange")
		Global $W1_T5_I_D1Avatar = GUICtrlCreateInput("Input1", 365, 94, 415, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T5_I_D2URL = GUICtrlCreateInput("Input1", 180, 153, 677, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetOnEvent(-1, "W1_T5_I_D2URLChange")
		Global $W1_T5_I_D2Bot = GUICtrlCreateInput("Input1", 180, 182, 101, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T5_I_D2Avatar = GUICtrlCreateInput("Input1", 364, 183, 415, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T5_I_D3URL = GUICtrlCreateInput("Input1", 178, 242, 677, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetOnEvent(-1, "W1_T5_I_D3URLChange")
		Global $W1_T5_I_D3Bot = GUICtrlCreateInput("Input1", 178, 271, 101, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T5_I_D3Avatar = GUICtrlCreateInput("Input1", 362, 272, 415, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T5_I_D4URL = GUICtrlCreateInput("Input1", 178, 328, 677, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetOnEvent(-1, "W1_T5_I_D4URLChange")
		Global $W1_T5_I_D4Bot = GUICtrlCreateInput("Input1", 178, 357, 101, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T5_I_D4Avatar = GUICtrlCreateInput("Input1", 362, 358, 415, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		GUICtrlCreateGroup("", -99, -99, 1, 1)
		Global $Pic4 = GUICtrlCreatePic("K:\AutoIT\_MyProgs\7dtdServerUpdateUtility\Pics\zombie2.jpg", 722, 406, 53, 123)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T6_I_Daily = GUICtrlCreateInput("W1_T6_I_Daily", 147, 92, 728, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T6_I_Update = GUICtrlCreateInput("Input13", 147, 121, 728, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T6_I_Remote = GUICtrlCreateInput("Input13", 147, 150, 728, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T6_I_BackOnline = GUICtrlCreateInput("W1_T6_I_BackOnline", 218, 190, 657, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T6_I_PlayerChange = GUICtrlCreateInput("Input13", 182, 249, 692, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetOnEvent(-1, "W1_T6_I_PlayerChangeChange")
		Global $W1_T6_I_SubJoined = GUICtrlCreateInput("Input13", 230, 276, 644, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T6_I_SubLeft = GUICtrlCreateInput("Input13", 230, 303, 644, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T6_I_SubOnlinePlayer = GUICtrlCreateInput("Input13", 230, 330, 644, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T6_I_PlayerDie = GUICtrlCreateInput("Input13", 312, 363, 562, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T6_I_PlayerChat = GUICtrlCreateInput("Input13", 312, 392, 562, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T6_I_BackupStarted = GUICtrlCreateInput("Input13", 142, 465, 732, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T7_I_TwitchDaily = GUICtrlCreateInput("Input13", 145, 107, 728, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T7_I_TwitchUpdate = GUICtrlCreateInput("Input13", 145, 136, 728, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T7_I_TwitchRemote = GUICtrlCreateInput("Input13", 145, 165, 728, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T7_I_TwitchNick = GUICtrlCreateInput("W1_T7_I_TwitchNick", 107, 227, 201, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetOnEvent(-1, "W1_T7_I_TwitchNickChange")
		Global $W1_T7_I_TwitchChatOAuth = GUICtrlCreateInput("Input1", 107, 254, 633, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetOnEvent(-1, "W1_T7_I_TwitchChatOAuthChange")
		Global $W1_T7_I_TwitchChannels = GUICtrlCreateInput("Input1", 107, 285, 633, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T7_I_TwitchBackStarted = GUICtrlCreateInput("Input13", 147, 380, 728, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T8_I_ExecuteAfterSteamandStart = GUICtrlCreateInput("W1_T1_I_DIR", 129, 91, 376, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T8_I_ExecuteAfterSteamBeforeStart = GUICtrlCreateInput("W1_T1_I_DIR", 129, 162, 376, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T8_I_ExecuteAfterUpdate = GUICtrlCreateInput("W1_T1_I_DIR", 129, 235, 376, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T8_I_ExecuteAfterRestart = GUICtrlCreateInput("W1_T1_I_DIR", 128, 312, 376, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T8_I_ExecuteAFirstRestartAnnouncement = GUICtrlCreateInput("W1_T1_I_DIR", 127, 385, 376, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T8_I_ExecuteRemoteRestart = GUICtrlCreateInput("W1_T1_I_DIR", 126, 452, 376, 24)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		GUICtrlCreateGroup("", -99, -99, 1, 1)
		Global $Pic5 = GUICtrlCreatePic("K:\AutoIT\_MyProgs\7dtdServerUpdateUtility\Pics\zombie3.jpg", 696, 94, 125, 353)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $Pic7 = GUICtrlCreatePic("K:\AutoIT\_MyProgs\7dtdServerUpdateUtility\Pics\zombieGroup.jpg", 134, 328, 637, 197)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T10_B_Restart = GUICtrlCreateButton("RESTART", 369, 138, 115, 29)
		GUICtrlSetFont(-1, 8, 800, 0, "MS Sans Serif")
		GUICtrlSetBkColor(-1, 0xF3E747)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetOnEvent(-1, "W1_T10_B_RestartClick")
		...
		Global $Label99 = GUICtrlCreateLabel("(Warning! Some settings will not take effect until utility is restarted)", 243, 246, 386, 20, $SS_CENTER)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
...
EndFunc   ;==>ConfigMaximize
Func ConfigMinimize()

EndFunc   ;==>ConfigMinimize
Func ConfigRestore()

EndFunc   ;==>ConfigRestore
...
EndFunc   ;==>Pic7Click
Func W_T3_I_RestartMinuteChange()

EndFunc   ;==>W_T3_I_RestartMinuteChange
...
Func W1_T10_B_RestartClick()
	ConfigClose()
	_RestartUtil()
EndFunc   ;==>W1_T10_B_RestartClick
...
Func W1_T3_C_ThurClick()

EndFunc   ;==>W1_T3_C_ThurClick
