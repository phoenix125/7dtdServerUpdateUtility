...
#AutoIt3Wrapper_Outfile=Builds\7dtdServerUpdateUtility_v2.5.0.exe
...
$aUtilVerStable = "v2.5.0" ; (2020-07-30)
$aUtilVerBeta = "v2.5.0" ; (2020-07-30)
...
;~ 		GUISetIcon("G:\Game Server Files\AutoIT\Icons\phoenix.ico", -1)
		...
		GUICtrlSetFont(-1, 10, 400, 0, "arial")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		Global $W1_T8_C_ExecuteBeforeSteamAndStart = GUICtrlCreateCheckbox("Execute before SteamCMD update and server start", 65, 70, 358, 17)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetOnEvent(-1, "W1_T8_C_ExecuteBeforeSteamAndStart")
		Global $W1_T8_C_ExecuteBeforeSteamAndStartWait = GUICtrlCreateCheckbox("Wait for script to complete", 430, 68, 179, 16)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		...
		Global $W1_T8_I_ExecuteBeforeSteamandStart = GUICtrlCreateInput("W1_T1_I_DIR", 129, 91, 376, 22)
		GUICtrlSetFont(-1, 8, 400, 0, "arial")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetOnEvent(-1, "W1_T8_B_ExecuteBeforeSteamandStart")
		...
		GUICtrlSetFont(-1, 8, 400, 0, "arial")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetOnEvent(-1, "W1_T8_I_ExecuteFirstRestartAnnouncementChange")
		...
		Global $W1_T8_C_ExecuteRemoteRestartWait = GUICtrlCreateCheckbox("Wait for script to complete", 427, 429, 179, 16)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		...
		Global $Label93 = GUICtrlCreateLabel("During updates, The Fun Pimps sometimes make changes to the ServerConfig.xml file, which can cause the server to fail to start when using the old config file." & @CRLF & _
				...
				"    ServerLoginConfirmationText, DropOnDeath" & @CRLF & "", 42, 272, 800, 180)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		...
		Global $W1_T9_C_RenameModFolder = GUICtrlCreateCheckbox("Rename the Mod Folder (therefore saving and disabling it) if Future Proof was needed (3 consecutive failed starts after an update)", 64, 140, 787, 29)
		GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
...
Func W1_T9_C_RenameModFolderClick() ;kim125er
